...
Examples:
    ...
    extractValue(arr,'name') // ['Sam', 'Tim', 'Matt', 'Bob']
*/
...
Examples:
    ...
    addKeyAndValue(arr, 'title', 'Instructor') // 
      [
        {title: 'Instructor', name: 'Sam'}, 
        {title: 'Instructor', name: 'Tim'}, 
        {title: 'Instructor', name: 'Matt'}, 
        {title: 'Instructor', name: 'Bob'}
       ]
*/
...
function on each value in the array and if the result of the callback function at that specific value is true, the value should be placed in the first subarray. If the result of the callback function at that specific value is false, the value should be placed in the second subarray. 
...
Examples:
    ...
    var names = ['Sam', 'Bob', 'Tim', 'Matt'];
    
    partition(names, isLongerThanThreeCharacters) // [['Sam', 'Bob', 'Matt'], ['Tim']]
*/
